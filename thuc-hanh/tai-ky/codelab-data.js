...
const session5Data = {
    ...
    exercises: [
        ...
        { 
            title: "Bài tập 1: Thiết lập hồ sơ kê khai thuế lần đầu", 
            theory: ["1. Hộ kinh doanh nhóm 2 (Doanh thu 1 tỷ - 3 tỷ) có những nghĩa vụ nộp thuế và sử dụng hóa đơn điện tử như thế nào theo quy định pháp luật hiện hành?", "2. Việc thiết lập hồ sơ kê khai thuế ngay trên KiotViet mang lại lợi ích tự động hóa như thế nào cho chủ cửa hàng trong việc quản lý hàng hóa?"],
            requirements: ["1. Thiết lập hồ sơ kê khai thuế lần đầu cho cửa hàng bán lẻ của bạn để tự động hóa việc tính toán.", "2. Sử dụng thông tin giả định: Mã số thuế là 'xxxxxxxxxx' (10 số, lưu ý tạo MST ảo, số đầu tiên nên là số khác 0), cửa hàng thuộc Nhóm doanh thu 1 và áp dụng gán mức thuế cho toàn bộ hàng hóa."], 
            instructions: ["1. Trên màn hình Quản lý, bạn truy cập vào menu Thuế & Kế toán -> chọn Thuế & Kế toán -> nhấn Tạo hồ sơ kê khai thuế.", "2. Tại màn hình Thông tin kinh doanh, bạn nhập Mã số thuế giả định là 'xxxxxxxxxx' (Tự tạo 10 số, lưu ý tạo MST ảo, số đầu tiên nên là số khác 0).", "3. Nhập thông tin Tên Hộ kinh doanh là Tạp hóa Vân Anh và chọn Ngày chuyển lên kê khai là ngày 01/01/2026.", "4. Tại bước gán chi nhánh, kiểm tra địa điểm kinh doanh hiện tại, chỉ định làm Trụ sở chính và nhấn Tiếp tục.", "5. Hệ thống hiển thị 4 nhóm doanh thu, bạn chọn Nhóm 2 (Doanh thu từ 1 tỷ - 3 tỷ), kiểm tra bảng Nghĩa vụ thuế bên phải rồi nhấn Tiếp tục.", "6. Tại bước Cài đặt thuế cho hàng hóa, chọn Thiết lập cho tất cả hàng hóa trong Danh mục hàng hóa KiotViet. Nhấn Tiếp tục.", "7. Kiểm tra bảng tóm tắt tỷ lệ thuế theo nhóm ngành nghề. Đảm bảo thông tin đã hợp lý rồi nhấn Tiếp tục.", "8. Xem lại toàn bộ thông tin, tích chọn Tôi đã đọc và xác nhận toàn bộ thông tin kê khai ở trên là chính xác và nhấn Hoàn thành."], 
            confirm: "Chụp ảnh màn hình thông báo hoàn tất thiết lập hoặc màn hình tờ khai thuế hiển thị rõ Mã số thuế ảo bạn đã tạo." 
        },
        { 
            title: "Bài tập 2: Thiết lập quản lý Thuế VAT & Đổi tỷ lệ tính thuế hàng hóa", 
            theory: ["1. Trình bày sự khác biệt cơ bản giữa Phương pháp tính thuế Trực tiếp và Phương pháp tính thuế Khấu trừ. Hộ kinh doanh bán buôn, bán lẻ thông thường sẽ áp dụng phương pháp nào?", "2. Tính năng cập nhật VAT hàng loạt trên danh sách hàng hóa giúp ích gì cho người quản trị so với cách làm cũ?"],
            requirements: ["1. Bật tính năng Thuế VAT cho cửa hàng và cấu hình sử dụng phương pháp tính thuế Trực tiếp với tỷ lệ 1% GTGT.", "2. Cập nhật tỷ lệ tính thuế riêng cho sản phẩm 'Nước giặt OMO Matic' từ 1% lên mức 3% GTGT."], 
            instructions: ["1. Tại màn hình Quản lý, vào menu Thiết lập (biểu tượng bánh răng) -> Xem tất cả thiết lập -> chọn Thuế & Kế toán.", "2. Bật xanh nút Thuế VAT -> xác nhận Bật tính năng.", "3. Hệ thống hiển thị popup Thiết lập thuế VAT, bạn chọn loại hình Cá nhân/Hộ kinh doanh -> nhấn Tiếp tục.", "4. Tại mục Tỷ lệ thuế mặc định, chọn 1% GTGT, 0,5 % TNCN. Tích chọn Giảm thuế GTGT theo Nghị quyết 204... và nhấn Lưu.", "5. Tiếp theo, chuyển sang menu Hàng hóa -> Danh sách hàng hóa, tìm kiếm sản phẩm giả định Nước giặt OMO Matic.", "6. Tích chọn vào sản phẩm 'Nước giặt OMO Matic', nhấn nút 3 chấm ở góc trên -> chọn Đổi tỷ lệ tính thuế.", "7. Trên popup hiện ra, chọn Tỷ lệ tính thuế mới là 3% GTGT -> nhấn Thay đổi."], 
            confirm: "Chụp ảnh màn hình Danh sách hàng hóa hiển thị sản phẩm 'Nước giặt OMO Matic' đã được gán thành công tỷ lệ thuế 3%." 
        },
        { 
            title: "Bài tập 3: Kích hoạt và Kết nối Hóa đơn điện tử KiotViet", 
            theory: ["1. Việc kết nối trực tiếp phần mềm Hóa đơn điện tử với phần mềm Quản lý bán hàng KiotViet giúp giải quyết triệt để những khó khăn gì về thời gian và thao tác cho thu ngân?", "2. Chức năng 'Tự động phát hành hóa đơn điện tử ngay trên Màn hình bán hàng' có tác dụng gì đối với việc tuân thủ pháp luật về thuế của hộ kinh doanh?"],
            requirements: ["1. Truy cập vào hệ thống Hóa đơn điện tử KiotViet và tiến hành khai báo hồ sơ doanh nghiệp bằng mã số thuế đã dùng ở Bài 1.", "2. Bật kết nối Hóa đơn điện tử trong thiết lập phần mềm và cấu hình để máy tự động phát hành hóa đơn ngay khi chốt đơn."], 
            instructions: ["1. Trên màn hình Quản lý KiotViet, chọn menu Thuế & Kế toán -> chọn Hóa đơn điện tử (Hệ thống sẽ tự động điều hướng sang trang chủ HĐĐT ở một tab mới).", "2. Tại bước Khai báo thông tin đơn vị, nhấn nút Thiết lập.", "3. Trên popup hiện ra, nhập Mã số thuế ảo bạn đã tạo trước đó, Tên đơn vị Tạp hóa Vân Anh, nhập Địa chỉ giả định (VD: 123 Thái Hà, Hà Nội).", "4. Tích chọn ô Tôi đã đọc và đồng ý... và nhấn Lưu để hoàn tất hồ sơ.", "5. Quay trở lại tab Màn hình Quản lý bán hàng KiotViet, vào Thiết lập -> Xem tất cả thiết lập -> chọn menu Hóa đơn điện tử bên tay trái và bật xanh tính năng.", "6. Chọn nhà cung cấp Hóa đơn điện tử KiotViet và nhấn Tiếp tục.", "7. Nhập lại Mã số thuế ảo, nhấn Tiếp tục và nhập mã OTP xác thực bằng số điện thoại đã khởi tạo gian hàng dùng thử được gửi về điện thoại/Zalo.", "8. Tại popup Thiết lập phát hành hóa đơn điện tử, bộ lọc chọn Mẫu hóa đơn không cần điền vì chưa khởi tạo.", "9. Tích chọn dòng Phát hành hóa đơn điện tử ngay trên Màn hình bán hàng."], 
            confirm: "Chụp ảnh màn hình giao diện kết nối hiển thị Tích chọn dòng Phát hành hóa đơn điện tử ngay trên Màn hình bán hàng." 
        }
    ]
};
  ...
  "Retail": [
      ...
      },
      {
        ...
        exercises: [
          ...
          { title: "Bài tập 2: Thêm mới nhân viên và tạo dữ liệu mồi", requirements: ["1. Thêm mới nhân viên 'Nguyễn Thị Lan' (Số điện thoại: 0988111222).", "2. Gán nhân viên Lan vào phòng ban 'Khối Cửa Hàng' với chức danh 'Nhân viên Bán hàng'.", "3. Tạo thêm một nhân viên nháp tên 'Nhân viên Test 01' (Số điện thoại: 0999000111)."], instructions: ["1. Tại màn hình Danh sách nhân viên, nhấn vào nút '+ Nhân viên' ở góc trên bên phải.", "2. Điền thông tin bắt buộc: Tên nhân viên là 'Nguyễn Thị Lan', Số điện thoại là '0988111222'.", "3. Chọn Chi nhánh làm việc hiện tại, chọn Phòng ban là 'Khối Cửa Hàng' và Chức danh là 'Nhân viên Bán hàng'.", "4. Nhấn Lưu để ghi nhận.", "5. Lặp lại các bước trên để thêm 'Nhân viên Test 01'."], confirm: "Chụp ảnh màn hình Danh sách nhân viên, hiển thị rõ tên của Nguyễn Thị Lan và Nhân viên Test 01 cùng các thông tương ứng." },
    ...
    <script>
        ...
        // ==========================================
        const API_URL = "https://script.google.com/macros/s/AKfycbw02rPVB0jTVQGvqVfJTYvoy3OjBz604srivuUOGmSHCdcnQ9tbHF4XI8zo32zxLz_S/exec"; 
        const SECURITY_TOKEN = "KIOT_RENEWAL_Q3_2026";

        let scenariosData = {};
        let currentDay = 'day1';
        let currentRoadmap = 'Retail'; 
        let currentRandomScenario = null;
        let currentStudentPracticeData = []; 
        ...
        function setTodayDate() {
            ...
            document.getElementById('reviewDate').value = `${String(today.getDate()).padStart(2, '0')}/${String(today.getMonth() + 1).padStart(2, '0')}/${today.getFullYear()}`;
        }

        // Tải danh sách tình huống Cẩm Nang
        function loadScenariosFromSheet() {
            fetch(`${API_URL}?token=${SECURITY_TOKEN}&action=getScenarios`)
            .then(res => res.json())
            .then(response => {
                if (response.status === "success" && response.data && response.data.length > 0) {
                    scenariosData = { day1: [], day2: [], day3: [] };
                    response.data.forEach(item => {
                        if (!item.Day || item.Day.toString().trim().toLowerCase() === "day") return; 
                        const dayKey = item.Day.toString().trim();
                        if (scenariosData[dayKey]) {
                            scenariosData[dayKey].push({
                                id: item.id || Math.random(), type: item.Type ? item.Type.toString().trim() : "",
                                title: item.Title, question: item.Question, answer: item.Answer,
                                roadmap: item.Roadmap ? item.Roadmap.toString().trim() : "" 
                            });
                        }
                    });
                    switchRoadmap('Retail'); // Khởi tạo mặc định
                }
            });
        }

        // Cập nhật điểm tự tin
        function updateScoreValue(val) {
            document.getElementById('scoreValue').textContent = val;
        }

        // Hàm ngắt câu an toàn (đã fix crash Safari)
        function formatSentences(text) {
            if (!text) return "";
            text = text.replace(/\n/g, '<br>');
            return text.replace(/([.?!])\s+([A-ZĐÁÀẢÃẠÂẤẦẨẪẬĂẮẰẲẴẶÉÈẺẼẸÊẾỀỂỄỆÍÌỈĨỊÓÒỎÕỌÔỐỒỔỖỘƠỚỜỞỠỢÚÙỦŨỤƯỨỪỬỮỰÝỲỶỸỴ])/g, "$1<br><br>$2");
        }
        ...
        // ==========================================
        // ĐIỀU HƯỚNG UI (NGÀNH, NGÀY, TAB)
        // ==========================================
        
        // 1. Chuyển Lộ trình
        function switchRoadmap(roadmap) {
            currentRoadmap = roadmap;
            document.getElementById('industry').value = roadmap; // Cập nhật vào Select
            
            const retailBtn = document.getElementById('roadmap-Retail');
            const fnbBtn = document.getElementById('roadmap-FNB');
            if (roadmap === 'Retail') {
                retailBtn.className = "flex-1 py-2.5 text-xs font-black rounded-xl transition-all bg-white text-[#166def] shadow-sm flex items-center justify-center gap-2";
                fnbBtn.className = "flex-1 py-2.5 text-xs font-black rounded-xl text-slate-600 transition-all flex items-center justify-center gap-2";
            } else {
                retailBtn.className = "flex-1 py-2.5 text-xs font-black rounded-xl text-slate-600 transition-all flex items-center justify-center gap-2";
                fnbBtn.className = "flex-1 py-2.5 text-xs font-black rounded-xl transition-all bg-white text-[#166def] shadow-sm flex items-center justify-center gap-2";
            }
            switchSubTab(currentDay);
        }

        // 2. Chuyển Ngày khi đổi Selectbox
        function switchSessionAndCheck() {
            const val = document.getElementById('session').value;
            if (val.includes("Phiên 1")) switchSubTab('day1');
            if (val.includes("Phiên 2")) switchSubTab('day2');
            if (val.includes("Phiên 3")) switchSubTab('day3');
        }

        // 3. Chuyển Ngày review
        function switchSubTab(day) {
            currentDay = day;
            document.getElementById('session').value = day === 'day1' ? "Phiên 1 (Cuối Ngày 1)" : day === 'day2' ? "Phiên 2 (Cuối Ngày 2)" : "Phiên 3 (Cuối Ngày 3)";
            
            // Đổi màu nút Ngày
            const tabs = ['day1', 'day2', 'day3'];
            tabs.forEach(item => {
                const button = document.getElementById(`sub-tab-${item}`);
                if (button) {
                    if (item === day) {
                        button.classList.add('bg-white', 'text-[#166def]', 'shadow-sm');
                        button.classList.remove('text-slate-600');
                    } else {
                        button.classList.remove('bg-white', 'text-[#166def]', 'shadow-sm');
                        button.classList.add('text-slate-600');
                    }
                }
            });

            // Đổi thông tin tiêu đề Giáo trình
            const headerIcon = document.getElementById('session-header-icon');
            const headerTitle = document.getElementById('session-header-title');
            const headerDesc = document.getElementById('session-header-desc');
            if (day === 'day1') {
                headerIcon.innerHTML = '<i class="fa-solid fa-store"></i>';
                headerTitle.textContent = "PHIÊN 1: KIẾN THỨC BÁN LẺ NỀN TẢNG";
                headerDesc.textContent = "Vận hành danh mục hàng hóa, kiểm soát kho và quản trị bảng giá đầu vào.";
            } else if (day === 'day2') {
                headerIcon.innerHTML = '<i class="fa-solid fa-cash-register"></i>';
                headerTitle.textContent = "PHIÊN 2: BÁN HÀNG NÂNG CAO & QUẢN TRỊ ĐA KÊNH";
                headerDesc.textContent = "Đặt - Bán - Trả hàng, tích hợp thanh toán nhanh, đồng bộ sàn TMĐT & khai thác báo cáo.";
            } else if (day === 'day3') {
                headerIcon.innerHTML = '<i class="fa-solid fa-calculator"></i>';
                headerTitle.textContent = "PHIÊN 3: PHÁP LÝ THUẾ & KẾ TOÁN HỘ KINH DOANH";
                headerDesc.textContent = "Xuất hóa đơn từ máy tính tiền, hoàn thiện 7 loại sổ kế toán (TT88) & Tờ khai thuế (TT40).";
            }

            // Gọi các hàm cập nhật liên quan
            triggerRandomScenario();
            renderAllScenarios(day);
            hideAllScenariosList();
            updateDynamicLinks(); 
            checkStudentPractice(); // Auto check lại % bài tập khi đổi tab
        }

        // 4. Chuyển Tab Main (Workspace / Handbook)
        function switchMainTab(tab) {
            const workspaceBtn = document.getElementById('main-tab-workspace');
            const handbookBtn = document.getElementById('main-tab-handbook');
            const workspaceContent = document.getElementById('main-content-workspace');
            const handbookContent = document.getElementById('main-content-handbook');

            if (tab === 'workspace') {
                workspaceBtn.className = "px-5 py-2 text-xs font-bold rounded-lg transition-all bg-white text-[#166def] shadow-sm flex items-center gap-2";
                handbookBtn.className = "px-5 py-2 text-xs font-bold rounded-lg text-blue-100 hover:text-white transition-all flex items-center gap-2";
                workspaceContent.classList.remove('hidden');
                workspaceContent.classList.add('grid');
                handbookContent.classList.add('hidden');
            } else {
                workspaceBtn.className = "px-5 py-2 text-xs font-bold rounded-lg text-blue-100 hover:text-white transition-all flex items-center gap-2";
                handbookBtn.className = "px-5 py-2 text-xs font-bold rounded-lg transition-all bg-white text-[#166def] shadow-sm flex items-center gap-2";
                workspaceContent.classList.add('hidden');
                workspaceContent.classList.remove('grid');
                handbookContent.classList.remove('hidden');
            }
        }

        // ==========================================
        // HIỂN THỊ TÌNH HUỐNG (CẨM NANG)
        // ==========================================
        function triggerRandomScenario() {
            const list = scenariosData[currentDay] ? scenariosData[currentDay].filter(item => item.roadmap === currentRoadmap) : [];
            const box = document.getElementById('random-scenario-box');
            if (!list || list.length === 0) { box.innerHTML = `<p class="text-xs py-6 text-center bg-white border border-dashed rounded-3xl">Lộ trình này chưa có dữ liệu tình huống chỉ định cho ngày hiện tại.</p>`; return; }
            
            currentRandomScenario = list[Math.floor(Math.random() * list.length)];
            const isMorning = currentRandomScenario.type === 'morning';
            const colorClass = isMorning ? 'bg-emerald-50 border-emerald-200 text-emerald-950' : 'bg-purple-50 border-purple-200 text-purple-950';
            const icon = isMorning ? '<i class="fa-solid fa-sun text-emerald-600"></i>' : '<i class="fa-solid fa-moon text-purple-600"></i>';
            const typeLabel = isMorning ? 'Học Phần Sáng' : 'Học Phần Chiều';

            box.innerHTML = `
                <div class="border-2 border-dashed border-[#166def]/30 rounded-3xl p-1 bg-white animate-fade">
                    <div class="${colorClass} rounded-2xl p-5 shadow-sm space-y-3">
                        <div class="flex items-center justify-between border-b pb-2 border-current/10">
                            <span class="text-xs font-black tracking-widest uppercase flex items-center gap-1.5">${icon} ${typeLabel} - ĐƯỢC CHỈ ĐỊNH</span>
                            <span class="text-[9px] font-bold px-2 py-0.5 rounded-full bg-white/70 border border-current/10">Random Selected</span>
                        </div>
                        <h4 class="font-extrabold text-sm text-slate-800">${escapeHtml(currentRandomScenario.title)}</h4>
                        <div class="text-xs space-y-3 pt-1">
                            <div class="leading-relaxed text-slate-600"><strong>Yêu cầu tư vấn:</strong> <div class="mt-1.5">${formatSentences(escapeHtml(currentRandomScenario.question))}</div></div>
                            <div class="leading-relaxed bg-white/95 p-3 rounded-xl border border-current/10 text-slate-700"><strong>Kỳ vọng trả lời:</strong> <div class="mt-1.5">${formatSentences(escapeHtml(currentRandomScenario.answer))}</div></div>
                        </div>
                    </div>
                </div>`;
        }

        function renderAllScenarios(day) {
            const container = document.getElementById('all-scenarios-list');
            const list = scenariosData[day] ? scenariosData[day].filter(item => item.roadmap === currentRoadmap) : [];

            if (!list || list.length === 0) {
                container.innerHTML = `<p class="text-xs text-slate-400 py-4 text-center">Chưa có dữ liệu tình huống lưu trữ nào khác.</p>`;
                return;
            }
            ...
            const morningTitle = `
                <div class="relative flex items-center justify-center my-6">
                    ...
                    <div class="relative bg-emerald-50 border border-emerald-200 px-6 py-2 rounded-full shadow-sm text-center">
                        <span class="text-xs font-black text-emerald-700 tracking-wider uppercase"><i class="fa-solid fa-sun mr-1.5"></i> HỌC PHẦN SÁNG</span>
                    </div>
                </div>`;

            const afternoonTitle = `
                <div class="relative flex items-center justify-center my-6">
                    <div class="absolute inset-0 flex items-center" aria-hidden="true"><div class="w-full border-t border-slate-200"></div></div>
                    <div class="relative bg-purple-50 border border-purple-200 px-6 py-2 rounded-full shadow-sm text-center">
                        <span class="text-xs font-black text-purple-700 tracking-wider uppercase"><i class="fa-solid fa-moon mr-1.5"></i> HỌC PHẦN CHIỀU</span>
                    </div>
                </div>`;

            const morningItems = list.filter(item => item.type === 'morning');
            const afternoonItems = list.filter(item => item.type === 'afternoon');

            let htmlContent = "";

            // Thống nhất quy chế màu sắc: Sáng dùng 1 màu xanh lá nhạt, chiều dùng màu tím nhạt [1]
            if (morningItems.length > 0) {
                htmlContent += morningTitle;
                htmlContent += `<div class="space-y-4">` + morningItems.map(item => `
                    <details name="scenarios-${day}" class="group border border-emerald-100 rounded-2xl bg-emerald-50/50 p-4 transition-all duration-200 hover:bg-emerald-50">
                        <summary class="font-bold text-xs cursor-pointer list-none flex justify-between items-center">
                            <span class="flex items-center gap-2.5"><i class="fa-solid fa-sun text-emerald-600"></i> ${escapeHtml(item.title)}</span>
                            <span class="transition group-open:rotate-180 text-slate-400"><i class="fa-solid fa-chevron-down text-[10px]"></i></span>
                        </summary>
                        <div class="mt-4 text-xs space-y-3 border-t pt-3 border-current/10">
                            <div class="leading-relaxed text-slate-600"><strong>Tình huống:</strong> <div class="mt-1.5">${formatSentences(escapeHtml(item.question))}</div></div>
                            <div class="leading-relaxed bg-white/95 p-3 rounded-xl border border-current/10 text-slate-700"><strong>Kỳ vọng đáp án:</strong> <div class="mt-1.5">${formatSentences(escapeHtml(item.answer))}</div></div>
                        </div>
                    </details>
                `).join('') + `</div>`;
            }
            ...
            if (afternoonItems.length > 0) {
                htmlContent += afternoonTitle;
                htmlContent += `<div class="space-y-4">` + afternoonItems.map(item => `
                    <details name="scenarios-${day}" class="group border border-purple-100 rounded-2xl bg-purple-50/50 p-4 transition-all duration-200 hover:bg-purple-50">
                        <summary class="font-bold text-xs cursor-pointer list-none flex justify-between items-center">
                            <span class="flex ietems-center gap-2.5"><i class="fa-solid fa-moon text-purple-600"></i> ${escapeHtml(item.title)}</span>
                            <span class="transition group-open:rotate-180 text-slate-400"><i class="fa-solid fa-chevron-down text-[10px]"></i></span>
                        </summary>
                        <div class="mt-4 text-xs space-y-3 border-t pt-3 border-current/10">
                            <div class="leading-relaxed text-slate-600"><strong>Tình huống:</strong> <div class="mt-1.5">${formatSentences(escapeHtml(item.question))}</div></div>
        ...
        // Ẩn danh sách lưu trữ tình huống khác
        function hideAllScenariosList() {
            const list = document.getElementById('all-scenarios-list');
            const btn = document.getElementById('toggle-list-btn');
            list.classList.add('hidden');
            btn.innerHTML = '<i class="fa-solid fa-eye"></i> Xem danh sách tất cả tình huống';
        }

        // Bật/tắt ẩn hiện danh sách tình huống lưu trữ [1]
        function toggleAllScenarios() {
            ...
            if (list.classList.contains('hidden')) {
                ...
                btn.innerHTML = '<i class="fa-solid fa-eye-slash"></i> Ẩn các tình huống lưu trữ';
            } else {
                list.classList.add('hidden');
                btn.innerHTML = '<i class="fa-solid fa-eye"></i> Xem danh sách tất cả tình huống';
            }
        ...
        // Đồng bộ selectbox Phiên review khi đổi selectbox thì chuyển tab
        document.getElementById('session').addEventListener('change', function(e) {
            const val = e.target.value;
            if (val === "Phiên 1 (Cuối Ngày 1)") switchSubTab('day1');
            if (val === "Phiên 2 (Cuối Ngày 2)") switchSubTab('day2');
            if (val === "Phiên 3 (Cuối Ngày 3)") switchSubTab('day3');
        });

        // Chọn Rating năng lực
        function selectRating(rating, element) {
            const buttons = document.querySelectorAll('.rating-btn');
            buttons.forEach(btn => {
                btn.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl bg-slate-50 text-slate-600 border border-slate-200 transition-all";
            });

            document.getElementById('selectedRating').value = rating;

            if (rating === 'Chưa đạt') {
                element.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl active-chuadat transition-all";
            } else if (rating === 'Đạt thao tác') {
                element.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl active-thaotac transition-all";
            } else if (rating === 'Đạt ứng dụng') {
                element.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl active-ungdung transition-all";
            } else if (rating === 'Tốt') {
                element.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl active-tot transition-all";
            }
        }

        // Gửi biểu mẫu lên Apps Script
        function submitForm(event) {
            event.preventDefault();

            // Kiểm tra định dạng ngày dd/mm/yyyy
            const rawDate = document.getElementById('reviewDate').value.trim();
            const dateRegex = /^\d{2}\/\d{2}\/\d{4}$/;
            if (!dateRegex.test(rawDate)) {
                showModal(false, "Sai định dạng ngày", "Vui lòng nhập Ngày Review theo đúng định dạng dd/mm/yyyy (Ví dụ: 14/07/2026).");
                return;
            }

            // Chuyển đổi định dạng ngày gửi lên sheet
            const parts = rawDate.split("/");
            const formattedDbDate = `${parts[2]}-${parts[1]}-${parts[0]}`;

            const rating = document.getElementById('selectedRating').value;
            if (!rating) {
                showModal(false, "Thiếu xếp loại", "Vui lòng chọn 1 trong 4 mức xếp loại năng lực.");
                return;
            }
            ...
            const payload = {
                ...
                reviewDate: formattedDbDate,
                homeworkStatus: document.getElementById('homeworkStatus').value,
                confidenceScore: parseInt(document.getElementById('confidenceScore').value),
                selfCheckEasy: document.getElementById('selfCheckEasy').value.trim(),
                selfCheckHard: document.getElementById('selfCheckHard').value.trim(),
                selfCheckApply: document.getElementById('selfCheckApply').value.trim(),
                scenarioNotes: document.getElementById('scenarioNotes').value.trim(),
                rating: rating,
                trainerNotes: document.getElementById('trainerNotes').value.trim(),
                actionPlan: document.getElementById('actionPlan').value.trim(),
                classCode: document.getElementById('classCode').value.trim(), // Mã lớp mới
                industry: document.getElementById('industry').value // Ngành hàng mới
            };
            ...
            .then(() => {
                ...
                showModal(true, "Gửi thành công", "Kết quả đã được cập nhật thành công lên Google Sheets của đội ngũ quản lý.");
                resetFormFields();
            })
            .catch(error => {
                setLoadingState(false);
                showModal(false, "Lỗi kết nối", "Không thể gửi dữ liệu. Vui lòng kiểm tra lại kết nối mạng hoặc liên hệ Admin.");
        ...
        function showModal(isSuccess, title, message) {
            ...
            if (isSuccess) {
                icon.className = "w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl bg-emerald-100 text-emerald-600";
                icon.innerHTML = '<i class="fa-solid fa-circle-check"></i>';
            } else {
                icon.className = "w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-4 text-xl bg-rose-100 text-rose-600";
        ...
        // Tự động khôi phục về trạng thái mặc định của lộ trình đang chọn khi lưu kết quả
        function resetFormFields() {
            document.getElementById('repName').value = "";
            document.getElementById('classCode').value = "";
            document.getElementById('homeworkStatus').selectedIndex = 0;
            document.getElementById('confidenceScore').value = 7;
            document.getElementById('scoreValue').textContent = "7";
            document.getElementById('selfCheckEasy').value = "";
            document.getElementById('selfCheckHard').value = "";
            document.getElementById('selfCheckApply').value = "";
            ...
            // Giữ đồng bộ dropdown ngành hàng theo tab đang chọn [1]
            document.getElementById('industry').value = currentRoadmap;

            document.getElementById('selectedRating').value = "";
            const buttons = document.querySelectorAll('.rating-btn');
            buttons.forEach(btn => {
                btn.className = "rating-btn py-2.5 text-[10px] font-black rounded-xl bg-slate-50 text-slate-600 transition-all";
            });
        }
    </script>
</body>
