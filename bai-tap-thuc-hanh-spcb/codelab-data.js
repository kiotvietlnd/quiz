...
const APP_CONFIG = {
    ...
    API_URL: "https://script.google.com/macros/s/AKfycbwZcmEDZRSp50SPz_GODP1FRBvLdy1LpfSJGGU_lRRJ9uA8RIcQg2ZZlQ5G89C-AePocA/exec", 
    COURSE_NAME: "26KV00" 
};

// ============================================================================
// DỮ LIỆU BÀI TẬP (100% CHUẨN XÁC TỪ FILE WORD - ĐÃ FORMAT CHỮ THƯỜNG DỄ ĐỌC)
// ============================================================================
const CODELAB_DATA = [
  {
    id: "session_1",
    ...
    exercises: [
      ...
      },
      {
        ...
        instructions: [
          ...
          "5. Tại khu vực Khách cần trả, chọn vào biểu tượng X để xóa phương thức hiển thị giá tiền 180.000.",
        ...
        confirm: "Chụp ảnh màn hình hiển thị rõ 2 phương thức thanh toán của Chị Lan trước khi thanh toán hoặc hóa đơn đã thanh toán thành công bằng 2 phương thức trên giao diện quản lý."
      },
      {
      ...
      },
      {
        ...
        confirm: "Chụp ảnh màn hình tab Nợ cần trả NCC của Nhà phân phối Unilever, hiển thị rõ lịch sử thanh toán phiếu chi và tab Nợ cần trả NCC của Nhà Phân Phối A, hiển thị rõ lịch sử nợ điều chỉnh."
      },
      {
    ...
    exercises: [
      ...
      },
      {
        ...
        instructions: [
          ...
          "5. Giao dịch xong, quan sát biểu tượng đồng bộ dữ liệu (hình đám mây/mũi tên vòng) kèm số lượng hóa đơn lưu tạm (HDO) trên góc màn hình. Bật lại mạng để hệ thống tự đồng bộ."
        ],
      ...
      },
      {
        ...
        requirements: [
          ...
          "3. (Lưu ý: Nếu trong hệ thống chưa có nhóm \"Thời trang trẻ em\", hãy tự tạo nhanh một vài sản phẩm thuộc nhóm này với mức giá lẻ bất kỳ trước khi làm bài)."
        ],
        instructions: [
      ...
      },
      {
        ...
        requirements: [
          "1. Ban quản lý cửa hàng quyết định: Riêng mặt hàng \"Khẩu trang trẻ em\" chỉ được phép giảm 5% so với giá bán lẻ, các sản phẩm khác trong nhóm vẫn giữ mức giảm 10%. Bạn cần điều chỉnh lại bảng giá sỉ."
        ],
        instructions: [
          ...
          "5. Sửa lại công thức thành - 5% (hoặc nhập trực tiếp số tiền giá sỉ mong muốn) và nhấn Enter để ghi nhận."
        ],
      ...
      },
      {
        ...
        requirements: [
          "1. Sau khi kiểm đếm thực tế, bạn phát hiện trong kho đang có sẵn 105 chiếc \"Khẩu trang trẻ em\", trong khi hệ thống đang ghi nhận tồn kho bằng 0. Bạn cần tạo phiếu kiểm kho để cập nhật."
        ],
        instructions: [
          ...
          "5. Bấm nút Hoàn thành để hệ thống tự động cập nhật tồn kho mới cho sản phẩm."
        ],
      ...
      },
      {
        ...
        requirements: [
          "1. Cửa hàng nhập 48 gói \"Mì tôm thanh long\" từ nhà cung cấp \"Thái Ninh\". Do đây là mặt hàng hoàn toàn mới, bạn cần tạo nhanh mã sản phẩm này ngay tại giao diện lập phiếu nhập."
        ],
        instructions: [
          ...
          "3. Khai báo thông tin: Tên \"Mì tôm thanh long\", Nhóm hàng \"Thực phẩm ăn liền\", Giá bán 12.000, Đơn vị tính \"Gói\". Nhấn Lưu.",
      ...
      },
      {
        ...
        requirements: [
          "1. Cửa hàng muốn lợi nhuận luôn được tính sát với biến động giá nhập kho, bạn cần cài đặt phương pháp tính giá vốn trung bình.",
        ...
        instructions: [
          ...
          "2. Chọn mục Hàng hóa, cuộn xuống phần Giá vốn, tồn kho. Kiểm tra xem hệ thống đã chọn tùy chọn Giá vốn trung bình chưa.",
      ...
      },
      {
        ...
        requirements: [
          "1. Nhà cung cấp \"Thái Ninh\" đang có KM cho sản phẩm \"Sting\": Nhập 50 lon (giá 8.000đ/lon) tặng kèm 1 lon miễn phí (giá 0đ). Bạn cần ghi nhận thực tế này trên cùng một phiếu nhập."
        ],
        instructions: [
          ...
          "4. Nhấn vào biểu tượng dấu cộng (+) xuất hiện ở cuối dòng \"Sting\" để tạo dòng nhập thứ 2.",
      ...
      },
      {
        ...
        requirements: [
          "1. Sau khi nhập sản phẩm Sting có 2 mức giá khác nhau, kiểm tra lại xem giá vốn của sản phẩm có tự động tính toán lại theo giá vốn trung bình hay không?"
        ],
        instructions: [
      ...
      },
      {
        ...
        requirements: [
          "1. Bạn nhập 100 Gói \"Mì tôm thanh long\". Giá bán lẻ đang cài là 12.000đ. Tuy nhiên, giá nhập đợt này bất ngờ tăng lên thành 13.000đ.",
        ...
        instructions: [
          ...
          "5. Hoàn tất việc nhập số tiền trả nhà cung cấp và nhấn Hoàn thành.",
          "6. Khi hệ thống hiển thị hộp thoại xác nhận \"Hệ thống sẽ cập nhật bảng giá mới...\", nhấn Đồng ý."
        ],
      ...
      },
      {
        ...
        requirements: [
          "1. Thiết lập tính năng tự động chuyển khách hàng vào \"Nhóm VIP\" khi tổng chi tiêu (trừ trả hàng) đạt 3.000.000đ.",
        ...
        instructions: [
          ...
          "6. Quay lại giao diện bán hàng, thêm mới 1 sản phẩm có tên \"Sản phẩm Test 01\" thuộc nhóm \"Khác\" với Giá bán 2.000.000. Tồn kho 5. Nhấn Lưu.",
          "7. Thêm vào đơn hàng Sản phẩm Test 01 với số lượng là 2 cho khách Lan Anh (Khách hàng mới). Nhấn Thanh toán.",
          "8. Tại màn hình bán hàng, tìm kiếm khách hàng Lan Anh, tại tab Thông tin > ô Nhóm > hiển thị Khách hàng này thuộc Nhóm VIP.",
          "9. Kiểm tra giao diện sau khi trả hàng: Tại màn hình bán hàng > Chọn biểu tưởng mũi tên trả hàng > Tìm hóa đơn chị Lan Anh > Trả 1 sản phẩm > Nhấn Trả hàng.",
          "10. Tìm lại khách hàng Lan Anh, kiểm tra tab Thông tin > ô Nhóm > khách hàng này không còn nằm trong Nhóm VIP."
        ],
      ...
      },
      {
        ...
        instructions: [
          ...
          "3. Khai báo thông tin tài khoản ngân hàng của bạn (Số tài khoản, Tên ngân hàng, Tên chủ thẻ) và nhấn Lưu."
        ],
      ...
      },
      {
        ...
        requirements: [
          "1. Cửa hàng chuẩn bị kinh doanh thêm loạt sản phẩm \"Thời trang mùa hè\". Thay vì tạo thủ công, bạn cần sử dụng file mẫu Excel để tải hàng loạt lên phần mềm."
        ],
        instructions: [
          "1. Vào mục Hàng hóa > Danh sách hàng hóa, nhấn biểu tượng Import và tải file mẫu về máy tính.",
          "2. Mở file Excel mẫu. Điền thử 1 dòng: Mã hàng \"TT001\", Tên hàng \"Áo thun mùa hè\", Loại hàng \"Hàng hóa\", Nhóm hàng \"Thời trang >> Thời trang mùa hè\", Giá vốn 50.000, Giá bán 150.000, Tồn kho 10. ĐVT: Chiếc. (Các cột Đang kinh doanh điền số 1).",
    ...
    exercises: [
      ...
      { title: '⚙️ Cài đặt thiết bị phần cứng', isGroupHeader: true },
      {
        ...
        instructions: [
          ...
          "2. Vào menu Thiết lập -> Cửa hàng -> Tìm và tải phần Driver cho phần cứng. (Hoặc tải trực tiếp tại khu vực Hỗ trợ).",
          "3. Mở file .exe vừa tải về và tiến hành cài đặt theo hướng dẫn.",
          ...
          "5. Chuyển sang thẻ Danh mục để xem danh sách toàn bộ driver mà ứng dụng hỗ trợ."
        ],
      ...
      },
      {
        ...
        requirements: [
          ...
          "3. Xem trước bản in hóa đơn trên màn hình Thu ngân và thiết lập tối ưu khổ giấy in."
        ],
        instructions: [
          "1. Mở thẻ Danh mục trên ứng dụng KiotViet Hardware Manager, tìm nhóm \"Máy in hóa đơn\" và nhấn nút Cài đặt.",
          "2. Đợi phần mềm tải và cài đặt thành công.",
          "3. Mở Printers & Scanners trên máy tính Windows, chọn máy in hóa đơn vừa cài -> Chọn Printer Properties.",
          "4. Chuyển sang thẻ Device Settings, tìm đến mục Cash Select. Chọn tùy chọn After Printing (Mở sau khi in) -> Nhấn OK.",
          "5. Truy cập màn hình Bán hàng (Thu ngân), chọn 1 sản phẩm và nhấn Thanh toán.",
          "6. Tại cửa sổ Print Preview, chọn máy in đích là máy in hóa đơn vừa cài.",
          "7. Nhấn vào Cài đặt khác, thiết lập Lề (Margins) chọn Không (None). Bỏ tích ở ô Đầu trang và chân trang."
        ],
      ...
      },
      {
        ...
        instructions: [
          "1. Trở lại thẻ Danh mục trên Hardware Manager, tìm máy in tem mã và nhấn Cài đặt.",
          ...
          "5. Mở KiotViet (Quản lý), vào menu Hàng hóa -> Danh mục.",
        ...
        confirm: "Chụp 2 ảnh màn hình: 1 ảnh bảng cấu hình Page Setup 72x22mm và 1 ảnh Print Preview in mã vạch."
      },
      {
        ...
        instructions: [
          ...
          "2. Tùy theo thiết bị hoặc giao diện đang sử dụng, tìm nút Màn hình phụ hoặc Kết nối màn QR (Thường nằm ở biểu tượng Menu 3 gạch).",
