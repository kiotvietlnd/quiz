...
const APP_CONFIG = {
    ...
    API_URL: "https://script.google.com/macros/s/AKfycbySxkRE_YnrK1XojK0_qlSH9RFP7rpDgZKMTzavdpvN5N045AKrhNVj4xYp18xzVfXhRw/exec", 
...
const CODELAB_DATA = [
  ...
  },
  {
    ...
    exercises: [
      {
        title: "Bài tập 1: Thêm mới sản phẩm ngay trên màn hình bán hàng", requirements: ["1. Khách muốn mua số lượng lớn \"Nước ngọt Fanta\" nhưng chưa có trên hệ thống. Bạn cần thêm mới sản phẩm này ngay tại màn hình thu ngân để không làm gián đoạn việc thanh toán."], instructions: ["1. Tại màn hình bán hàng, gõ từ khóa \"Nước ngọt Fanta\" vào ô tìm kiếm.", "2. Hệ thống báo không tìm thấy, bạn nhấn vào nút + Thêm mới hàng hóa vừa xuất hiện.", "3. Khai báo thông tin cho sản phẩm: Nhóm hàng \"Nước giải khát\", Giá vốn 12.000, Giá bán nhập 15.000, Tồn kho nhập 100, ĐVT \"Chai\". Nhấn Lưu."], confirm: "Chụp ảnh màn hình bán hàng có chứa sản phẩm \"Nước ngọt Fanta\" trong giỏ hàng."
      },
      {
        title: "Bài tập 2: Tra cứu thông tin và vị trí sản phẩm", requirements: ["1. Tra cứu nhanh vị trí trưng bày của \"Nước ngọt Fanta\" để hướng dẫn khách."], instructions: ["1. Tại ô tìm kiếm trên màn hình bán hàng, gõ \"Fanta\".", "2. Nhấn trực tiếp vào hình ảnh của sản phẩm.", "3. Kiểm tra thông tin: Giá bán, Tồn kho và Vị trí trưng bày.", "4. Nhấn Xong để đóng cửa sổ."], confirm: "Chụp ảnh màn hình cửa sổ popup chi tiết thông tin sản phẩm Fanta."
      },
      {
        title: "Bài tập 3: Tìm kiếm theo nhóm hàng và hiển thị tồn kho", requirements: ["1. Lọc tất cả sản phẩm thuộc nhóm \"Nước giải khát\" và bật hiển thị số lượng tồn kho."], instructions: ["1. Tại màn hình bán thường, nhấn vào biểu tượng Bộ lọc theo nhóm hàng, nằm cạnh ô tìm kiếm sản phẩm.", "2. Chọn nhóm hàng Nước giải khát và nhấn Xong. Hệ thống sẽ liệt kê các mặt hàng thuộc nhóm này (bao gồm Nước ngọt Fanta vừa tạo).", "3. Nhấn vào biểu tượng Menu ba dấu gạch ngang ở góc màn hình -> chọn Tùy chọn hiển thị.", "4. Chọn tab Khác, gạt bật tính năng Tồn kho.", "5. Quan sát số lượng tồn kho thực tế hiển thị dưới mỗi sản phẩm."], confirm: "Chụp ảnh màn hình danh sách sản phẩm đã lọc theo nhóm Nước giải khát, có hiển thị rõ số tồn kho."
      },
      {
        title: "Bài tập 4: Lập phiếu thu công nợ khách hàng", requirements: ["1. Khách hàng \"Thanh Vân\" đến thanh toán khoản nợ cũ 150.000đ bằng tiền mặt, không mua hàng mới. Bạn cần xử lý thu nợ ngay tại quầy."], instructions: ["1. 1.Bán cho khách hàng mới tên Thanh Vân 1 đơn hàng Nước ngọt Fanta số lượng 10 chai có giá 150.000. Chọn nút Thanh toán, tại ô Khách thanh toán, điều chỉnh số tiền phải thanh toán là 0, hệ thống sẽ hiển thị đơn hàng của Thanh Vân được tính vào công nợ là -150.000. Nhấn nút Thanh toán để hoàn tất đơn bán hàng.", "2. Tại màn hình bán hàng, nhấn vào biểu tượng Menu (ba dấu gạch ngang) -> chọn Lập phiếu thu.", "3. Tại ô tìm kiếm, nhập tên khách hàng \"Thanh Vân\" để chọn đúng khách hàng (Hệ thống sẽ hiển thị dư nợ hiện tại).", "4. 4.Nhập số tiền khách thanh toán thực tế vào ô Thu từ Khách hoặc Tiền thu là 150.000.", "5. Chọn biểu tượng ba chấm để chọn phương thức thanh toán là Tiền mặt.", "6. Nhấn nút Tạo phiếu thu."], confirm: "Chụp ảnh màn hình thông báo Đã tạo phiếu thu thành công cho Thanh Vân."
      },
      {
        title: "Bài tập 5: Thiết lập giới hạn thời gian trả hàng", requirements: ["1. Áp dụng chính sách: Chỉ cho phép trả hàng trong vòng 3 ngày kể từ ngày mua.", "2. Chỉ hiển thị cảnh báo, không chặn hoàn toàn."], instructions: ["1. Tại màn hình Quản lý, vào Thiết lập (biểu tượng bánh răng) -> chọn Xem tất cả thiết lập.", "2. Chuyển sang tab Đơn hàng, tìm đến tính năng Giới hạn thời gian trả hàng và gạt nút (màu xanh).", "3. Điền số \"3\" vào ô ngày quy định và nhấn Lưu.", "4. Tích chọn vào tùy chọn Hiển thị Cảnh báo khi trả hàng."], confirm: "Chụp ảnh màn hình phần thiết lập đã lưu thành công tính năng giới hạn 3 ngày và chọn chế độ cảnh báo."
      },
      {
        title: "Bài tập 6: Trả hàng nhanh không cần hóa đơn", requirements: ["1. Khách \"Thanh Vân\" mang 10 chai \"Nước ngọt Fanta\" đến trả lại lấy tiền mặt, không có hóa đơn gốc."], instructions: ["1. Tại màn hình Bán hàng, nhấn nút Trả hàng (Mũi tên quay đầu) ở góc trên cùng -> chọn Trả nhanh.", "2. Tại ô tìm kiếm sản phẩm trả, gõ \"Nước ngọt Fanta\" và chọn sản phẩm.", "3. Điều chỉnh số lượng khách hàng trả lại thành 10.", "4. Tại ô khách hàng, tìm và chọn \"Thanh Vân\". Phương thức hoàn tiền chọn Tiền mặt.", "5. Nhấn nút Trả hàng để hoàn tất phiếu."], confirm: "Chụp ảnh màn hình phiếu trả hàng nhanh."
      },
      {
        title: "Bài tập 7: Thiết lập bán hàng Offline khi mất mạng", requirements: ["1. Đề phòng sự cố đứt mạng, cửa hàng yêu cầu lưu đường dẫn bán hàng Offline vào trình duyệt.", "2. Giả lập mất mạng và thực hiện 1 giao dịch bán thử \"Nước ngọt Fanta\" để kiểm tra chế độ lưu tạm hóa đơn."], instructions: ["1. Khi máy tính đang có Internet, tại màn hình bán hàng, nhấn vào biểu tượng Ngôi sao trên thanh địa chỉ của trình duyệt web.", "2. Đặt tên gợi nhớ là \"KiotViet Bán Hàng\" và nhấn Xong.", "3. Giả lập mất mạng: Tắt kết nối Wifi/Ethernet trên máy tính của bạn. Sau đó nhấn tải lại trang (F5) màn hình bán hàng.", "4. Màn hình xuất hiện dải thông báo màu hồng báo hiệu đang ở chế độ Offline. Thực hiện bán \"Nước ngọt Fanta\".", "5. Quan sát biểu tượng đồng bộ dữ liệu (hình đám mây/mũi tên vòng) kèm số lượng hóa đơn lưu tạm (HDO) trên góc màn hình. Bật lại mạng để hệ thống tự đồng bộ."], confirm: "Chụp ảnh màn hình bán hàng lúc đang tắt mạng, hiển thị dải thông báo Offline màu hồng và biểu tượng chờ đồng bộ hóa đơn."
      },
      {
        title: "Bài tập 8: Thêm mới hàng hóa dịch vụ", requirements: ["1. Cửa hàng triển khai thêm dịch vụ \"Giặt là áo sơ mi\", giá 30.000đ/chiếc, không quản lý tồn kho."], instructions: ["1. Từ màn hình quản lý, truy cập menu Hàng hóa -> chọn Danh sách hàng hóa.", "2. Bấm nút + Tạo mới -> chọn Dịch vụ.", "3. Nhập Tên \"Dịch vụ giặt là áo sơ mi\", Nhóm hàng \"Giặt là\", Giá bán 30.000, ĐVT \"Chiếc\". Bấm Lưu."], confirm: "Chụp ảnh màn hình Danh sách hàng hóa, hiển thị \"Dịch vụ giặt là áo sơ mi\" (cột tồn kho hiện ---)."
      },
      {
        title: "Bài tập 9: Thiết lập bảng giá theo công thức", requirements: ["1. Cửa hàng cần áp dụng mức giá sỉ ưu đãi cho tất cả các sản phẩm thuộc nhóm \"Thời trang trẻ em\".", "2. Quy tắc giá sỉ: Thấp hơn 10% so với giá bán lẻ (giá chung), tự động làm tròn đến hàng nghìn đồng và sẽ tự động cập nhật nếu giá bán lẻ thay đổi ((Lưu ý: Nếu trong hệ thống chưa có nhóm "Thời trang trẻ em", hãy tự tạo nhanh một vài sản phẩm thuộc nhóm này, ví dụ: "Áo thun bé trai", "Khẩu trang trẻ em",... với mức giá lẻ bất kỳ trước khi làm bài)."], instructions: ["1. Truy cập menu Hàng hóa -> chọn Thiết lập giá.", "2. Bấm nút + Bảng giá để tạo bảng giá mới.", "3. Nhập Tên bảng giá là \"Bảng giá sỉ thời trang trẻ em\".", "4. Tại mục Công thức giá: Chọn Bảng Giá chung, dấu -, nhập 10, chọn %.", "5. Tích chọn ô Tự động cập nhật theo Bảng giá chung, chọn quy tắc làm tròn giá đến nghìn đồng. Bấm Lưu.", "6. Sau khi bảng giá được tạo, bấm vào nút Thêm theo nhóm hàng, chọn nhóm \"Thời trang trẻ em\" và nhấn Thêm vào bảng giá."], confirm: "Chụp ảnh màn hình \"Bảng giá sỉ thời trang trẻ em\" đang hiển thị danh sách các sản phẩm thuộc nhóm Thời trang trẻ em, với mức giá đã được giảm 10%)."
      },
      {
